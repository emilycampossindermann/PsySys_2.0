...
def create_about(app):
    return html.Div([
            ...
            html.Div([
                ...
                html.P("Feedback? We would be happy to hear your thoughts via e-mail to campos.sindermann@gmail.com", style={'marginTop': '-15px', 'color': 'grey', 'marginRight': '100px', 'fontWeight': 'bold', 'marginLeft': '70px'}),
